...
import SDBITLOGO from "../../public/SDB IT Logo.png";
                ...
                <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-8">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <CardDescription className="mb-4 text-base font-medium text-foreground">
                      TS4U IT Engineering Bootcamp - Dhaka
                    </CardDescription>
                    ...
                    <div className="flex flex-col gap-2 text-sm text-muted-foreground sm:flex-row sm:gap-6">
                      ...
                      <div className="flex items-center justify-center gap-2 sm:justify-start">
                        ...
                        <span className="whitespace-nowrap">On-site</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="p-6 sm:p-8">
                ...
                >
                  ...
                  <p className="leading-relaxed text-muted-foreground">
                    ...
                    Engineering Bootcamp, where I am responsible for developing
                    and optimizing user interfaces, ensuring they are both
                    visually appealing and highly functional. My experience in
                    the MERN Stack has equipped me with the skills needed to
                    contribute effectively to my team's projects and meet the
            ...
            <Card className={`overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm md:h-[800px]`}>
              ...
              <CardContent className="p-6 sm:p-8">
                ...
                >
                  ...
                  <p className="leading-relaxed text-muted-foreground">
                    As an Operations Manager & HR at SDB IT, I am responsible
                    for managing both administrative and HR functions. My role
                    covers payroll, office operations, vendor management, and
                    staff supervision while ensuring a smooth and efficient
                ...
                >
                  ...
                  <ul className="grid gap-3 sm:grid-cols-2">
                    {[
                      "Managed payroll, salary sheet, and accurate salary distribution.",
                      "Led full setup of new office including interior, electrical, and vendor management.",
                      "Supervised staff productivity and monitored workflow efficiency.",
                      "Handled HR tasks including offer letters, onboarding, and terminations.",
                      "Took charge of multi-role duties including HR, Product Management, Operations, and Finance.",
                ...
                >
                  <div className="mb-4 flex items-center gap-2">
                    <Code className="h-5 w-5 text-primary" />
                    <h3 className="text-lg font-semibold">Tools & Skills</h3>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {[
                      "Payroll Management",
